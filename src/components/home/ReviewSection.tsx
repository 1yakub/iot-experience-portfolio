...
import { JohnAvatar, AliceAvatar, DavidAvatar, SophiaAvatar } from '@/components/icons/avatars'
...
const reviews: Review[] = [
  {
    ...
    content: 'The smart factory solution revolutionized our manufacturing process. We\'ve seen a 40% increase in efficiency and significant cost reduction.',
    rating: 5,
  ...
  },
  {
    ...
    content: 'Their IoT infrastructure has transformed our city\'s traffic management. The real-time monitoring and adaptive systems are incredible.',
    rating: 5,
  ...
  },
  {
    ...
    content: 'The agricultural IoT sensors and automation have helped us optimize irrigation and reduce water usage by 30%. Outstanding results!',
    rating: 5,
  ...
  },
  {
    ...
    content: 'Their healthcare IoT solutions have significantly improved our patient monitoring capabilities and operational efficiency.',
    rating: 5,
...
const categories = ['All', 'Industrial IoT', 'Smart City', 'Agriculture', 'Healthcare']
...
function ReviewCard({ review, index }: { review: Review; index: number }) {
  ...
  return (
    ...
    >
      {/* Gradient Border */}
      <div className="absolute inset-0 bg-gradient-to-br from-[#0984E3] via-[#00B894] to-[#6C5CE7] opacity-0 group-hover:opacity-100 transition-opacity duration-300" style={{ padding: '2px' }}>
      ...
      <div className="p-8 relative">
        ...
        >
          <motion.span 
            ...
            style={{ 
              backgroundColor: `${categoryColors[review.category as keyof typeof categoryColors]}20`,
              color: categoryColors[review.category as keyof typeof categoryColors]
            }}
    ...
    <section className="py-20 bg-gradient-to-b from-gray-50 to-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          >
            Discover how our IoT solutions are transforming businesses across industries
          </motion.p>
        </div>
