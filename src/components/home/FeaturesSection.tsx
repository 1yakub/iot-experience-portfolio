    ...
    <section className='py-20 bg-[#F5F6FA] relative overflow-hidden'>
      ...
      <div className='container mx-auto px-4 relative'>
        ...
        >
          ...
          >
            Discover how our IoT solutions can transform your business and
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl mx-auto'>
          {features.map((feature, index) => (
            ...
            >
              <div
                className={`absolute inset-0 bg-gradient-to-r ${feature.color} transform rotate-6 rounded-lg opacity-0 group-hover:opacity-20 transition-opacity duration-300`}
              />
              <div className='bg-white p-8 border-4 border-[#2D3436] relative transform hover:-translate-y-2 transition-transform duration-300'>
                ...
                <h3 className='text-2xl font-bold mb-4 text-[#2D3436]'>
                  {feature.title}
                </h3>
